...
/* ---------- Navbar (sticky, visibility by scroll) ---------- */
...
/* ---------- Simple union-based NavbarButton (no generics; no TS 'never') ---------- */
...
type NavbarButtonProps = Shared & (LinkButtonProps | RealButtonProps);
...
export function NavbarButton(props: NavbarButtonProps) {
  ...
  if (props.as === "button") {
    const { as, ...rest } = props as RealButtonProps & Shared;
    return (
  ...
  // default: anchor
  const { as, href, ...rest } = props as LinkButtonProps & Shared;
  return (
